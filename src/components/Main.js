...
function Main() {
  ...
  return (
    <>
      {/* navigation bar */}
      <Nav link="Doc" setscreen={setscreen} />
      {screen ? (
        <Board />
      ) : (
        <>
          ...
          <div className="row mt-5">
            <div className="col-md-11 mx-auto bg-dark rounded">
              <p className="display-2 fw-light text-center text-light p-5">
                Say <span className="text-danger fw-bold">goodbye</span> to
                tedious database configurations and{" "}
                <span className="text-danger fw-bold">hello</span> to seamless
                data manipulation !
              </p>
            </div>
          </div>
          ...
          <div className="row my-5">
            <div className="col-md-10 mx-auto bg-light border border-secondary shadow p-5 rounded border-opacity-25">
              ...
              <hr />
              <h3 className="text-start text-primary">create your database</h3>
              <div className="row">
              ...
              <p className="text-muted">
                {" "}
                <span className="text-danger fw-bold">*</span> copy generated
                query and integrate in to your codebase
              </p>
              <div className="row">
                <div className="col-md-8">
                  <select
